...
class RoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $writer->givePermissionTo(['news.index', 'news.create', 'news.store', 'news.show', 'news.update', 'news.destroy', 'profile.index', 'profile.create', 'profile.update', 'profile.change.password', 'news.view']);
